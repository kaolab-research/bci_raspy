...
class RaspyModule():
    ...
    '''
    def __init__(self, constructor_fname, loop_fname, destructor_fname, signals, module, shm_pid=None):
        ...
        self.shm_pid = shm_pid
        self.shm_setup(signals, module, shm_pid)
        return
    ...
    def destructor(self):
        ...
        if self._destructor is not None:
            ...
            return False
        return True
    def shm_setup(self, signals, module, pid=None):
        self.m_shm = util.shm_setup(signals, module, pid) # Shared memory setup
...
def proc(signals, module, p_in: list, p_out: list, trigger=None, log_queue=None,
    ...
    this_module = RaspyModule(constructor_fname, loop_fname, destructor_fname, signals, module, shm_pid=os.getppid())
    # signals: dict of info for shared memory
    #   each item is a dictionary with shape and dtype
    #   e.g. signals['var_name'] = {'shape': (3, 2), 'dtype': 'float64'}
    # module: dict of info for the relevant module
